...
| R7 | Resample lineal deja alias (44.1/48 → 16 kHz) | Alta (estado actual) | Media | Pregunta Nyquist / anti-alias | Honestidad: `audio-resampler.ts` declara que **aún no hay** low-pass. Issues #65 (Luna) y #92 (Jahel). No forzar `sampleRate` en `getUserMedia` (`CAPTURE-INVARIANTS.md`) | Luna (#65) / Jahel (#92) |

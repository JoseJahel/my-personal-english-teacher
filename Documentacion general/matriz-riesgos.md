...
| R6 | Score 0–100 mide locutor, no pronunciación | Baja (política aplicada) | Alta | Pregunta de tribunal: “¿no están midiendo el timbre?” | Medido (#95): Δlocutor **11.4** ≳ Δerror vocal **9.2** (ratio **1.23**) en `scorePronunciationFromMonoPcm`. Conversación **sin** 0–100; la nota está en **Repetir**. Fuente: `speaker-bias-invariants.ts`, `calibracion-score-pronunciacion.md` §6 | Jahel (#95) |

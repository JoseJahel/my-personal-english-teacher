...
| RE-04 | Calibración fina del score con hablantes reales | Baja | Equipo | `dsp/pronunciation-score.ts` (issue #29) | Parcial | `dsp/pronunciation-score.test.ts` | Umbrales por calibrar |
